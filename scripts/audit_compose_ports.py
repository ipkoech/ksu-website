...
INTERNAL = {"main", "research", "library", "postgres", "redis", "celery-main", "celery-library", "celery-research", "web-prod", "admin-prod", "research-web-prod", "library-web-prod", "heri-web-prod", "gateway", "research-gateway"}
