...
export default async function LibraryContactPage() {
  ...
  return (
    <main id="library-main" className="min-h-screen bg-white">
      ...
      <section id="hours" className="scroll-mt-24 border-y border-border bg-surface-subtle px-4 py-14 sm:px-6 lg:px-8">
        <div className="mx-auto w-full max-w-[1680px]">
          <div className="mb-8 max-w-3xl">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-secondary sm:text-sm">Opening hours</p>
            <h2 className="mt-3 text-balance font-[family-name:var(--font-display)] text-3xl font-semibold leading-tight text-foreground sm:text-5xl">Branch operating hours</h2>
          ...
          <div className="grid gap-5 lg:grid-cols-2">
            {groupedHours.length === 0 ? (
              ...
              groupedHours.map(({ branch, hours }) => (
                <article key={branch.id} className="rounded-lg border border-border bg-white p-5 shadow-sm">
      ...
      <EditorialSection eyebrow="Send a question" title="We are here to help" body="Tell us what you are trying to find, the branch or resource involved, and any deadline that will help the team respond quickly.">
      ...
      <EditorialSection eyebrow="Contact alternatives" title="Use the published details for your branch" body="For urgent branch-specific questions, use the direct contacts below or visit the branch during its published hours." tone="soft">
