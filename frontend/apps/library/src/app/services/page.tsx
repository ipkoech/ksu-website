...
export default async function LibraryServicesPage({ searchParams }: ServicesPageProps) {
  ...
  return (
    <main id="library-main" className="min-h-screen bg-white">
      ...
      <div id="services-heading" className="scroll-mt-24"><EditorialSection eyebrow="Service overview" title="A library service for every academic task" body="Library services are published by branch and maintained by the library team. Start with the service list, then contact us when your request needs personal support.">
      ...
      <div id="branches-heading" className="scroll-mt-24"><EditorialSection eyebrow="Branches" title="Where services are available" body="Choose a branch for local contacts and visit planning. Published hours are available on the contact page.">
      ...
      <div id="regulations-heading" className="scroll-mt-24"><EditorialSection eyebrow="Policies and regulations" title="Know the guidance before you visit" body="Review active borrowing, access, conduct, and fee guidance published by the Library.">
