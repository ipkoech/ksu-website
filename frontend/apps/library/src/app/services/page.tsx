...
export default async function LibraryServicesPage({ searchParams }: ServicesPageProps) {
  ...
  return (
    <main id="library-main" className="min-h-screen bg-white">
      ...
      <EditorialSection eyebrow="Service overview" title="A library service for every academic task" body="Library services are published by branch and maintained by the library team. Start with the service list, then contact us when your request needs personal support.">
