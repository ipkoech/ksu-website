...
test("chancellor and vice chancellor pages use backend messages and supplied imagery", () => {
  ...
  assert.doesNotMatch(chancellorSource, /CHANCELLOR_MANDATES/);
  assert.doesNotMatch(chancellorSource, /Governance context/);
  assert.doesNotMatch(chancellorSource, /MessageCtas/);
  assert.doesNotMatch(chancellorSource, /Titular head/);
  assert.doesNotMatch(chancellorSource, /Connect with Kisii University/);
  ...
  assert.doesNotMatch(viceChancellorSource, /VC_MANDATES/);
  assert.doesNotMatch(viceChancellorSource, /Implementation context/);
  assert.doesNotMatch(viceChancellorSource, /MessageCtas/);
  assert.doesNotMatch(viceChancellorSource, /PRIORITY_POINTS/);
  assert.doesNotMatch(viceChancellorSource, /Quality teaching and learning/);
  assert.doesNotMatch(viceChancellorSource, /Join Kisii University/);
