...
function AssignmentCard({
  ...
  return (
    <article className="min-w-0 rounded-[1.1rem] border border-border bg-white p-3 shadow-sm">
      ...
      <dl className="mt-3 grid gap-2 border-t border-border pt-3 text-xs">
        ...
        {reportsTo ? (
          <div className="min-w-0">
            <dt className="font-semibold text-muted-foreground">Reports to</dt>
            <dd className="mt-0.5 truncate font-semibold text-muted-foreground">
        ...
        <div className="flex min-w-0 flex-wrap gap-1.5">
          ...
          {assignment.is_primary ? (
            <span className="rounded-full bg-surface-muted px-2 py-1 font-bold text-muted-foreground">
              Primary
            </span>
          ) : null}
          {directReports ? (
