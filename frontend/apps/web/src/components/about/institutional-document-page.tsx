...
export function InstitutionalDocumentPage({
  ...
  return (
    <div className="bg-[#fbfaf6]">
      ...
      <AboutReveal className="mx-auto grid w-full gap-10 px-5 py-12 sm:px-8 lg:grid-cols-[.8fr_1.2fr] lg:px-10">
