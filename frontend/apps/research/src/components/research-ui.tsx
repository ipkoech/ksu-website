...
export function ResearchHero({
  ...
  return (
    <section className="border-b border-slate-200 bg-[linear-gradient(135deg,#102a43_0%,#155e75_52%,#c2410c_100%)] px-4 py-12 text-white sm:px-6 lg:px-8">
      <div className="mx-auto grid max-w-[1320px] gap-10 lg:grid-cols-[minmax(0,1fr)_400px] lg:items-end">
