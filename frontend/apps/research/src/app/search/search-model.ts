...
export const RESEARCH_SEARCH_GROUPS: ResearchSearchGroup[] = [
  {
    ...
    tab: "projects",
    icon: FlaskConical,
    defaultImage: "/images/research/verified/multidisciplinary-conference-2026.jpg",
  ...
  },
  {
    ...
    tab: "publications",
    icon: BookOpen,
    defaultImage: "/images/research/verified/riana-outreach-01.jpeg",
    titleFields: ["title", "name"],
  ...
  },
  {
    ...
    tab: "funding",
    icon: Award,
    defaultImage: "/images/research/verified/environment-03.jpeg",
    titleFields: ["title", "name"],
  ...
  },
  {
    ...
    tab: "innovation",
    icon: Lightbulb,
    defaultImage: "/images/research/verified/innovation-week-03.jpeg",
    titleFields: ["title", "name"],
  ...
  },
  {
    ...
    tab: "partners",
    icon: Handshake,
    defaultImage: "/images/research/verified/innovation-week-12.jpeg",
  ...
  },
  {
    ...
    tab: "projects",
    icon: Target,
    defaultImage: "/images/research/verified/environment-01.jpeg",
    titleFields: ["name", "title"],
