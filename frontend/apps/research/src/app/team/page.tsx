...
export default async function TeamPage() {
  ...
  return (
    <main id="research-main" className="min-h-screen bg-white">
      ...
      <section className="border-b border-border bg-white px-4 py-10 sm:px-6 lg:px-8 xl:px-10 2xl:px-12">
        <div className="mx-auto max-w-[1680px]">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
              {people.map((person) => (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group rounded-lg border border-border bg-white p-5 shadow-sm transition hover:border-primary/30 hover:shadow-md"
                >
                  <div className="flex h-12 w-12 items-center justify-center rounded-full bg-primary/10 text-primary">
                    <UserRound aria-hidden className="h-6 w-6" />
                  </div>
                  <h3 className="mt-4 font-[family-name:var(--font-display)] text-lg font-semibold text-foreground group-hover:text-primary">
                    {personName(person)}
                  </h3>
          ...
          <div className="mt-8 rounded-[1.25rem] border border-border bg-accent/60 p-6">
