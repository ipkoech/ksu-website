...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return researchRecordMetadata(data, { fallbackTitle: "Resource", pathname: "/resources-tools/" + slug });
}
