...
export default async function ResourcesToolsPage({ searchParams }: { searchParams?: Promise<ResourceParams> }) {
  ...
  return (
    <main id="research-main" className="min-h-screen bg-white">
      <ResearchClusterHero eyebrow="Funding / Support" title="Research resources, tools, equipment, and platforms." body="Browse available research equipment, facilities, datasets, forms, software, and bookable tools with access and contact details." breadcrumbs={[{ label: "Home", href: "/" }, { label: "Funding", href: "/funding" }, { label: "Resources & Tools" }]} imageSrc="/images/research/research-hero-imagegen.webp" imageAlt="Research tools, platforms, equipment, and support resources" links={supportLinks} primaryAction={{ label: "Open services", href: "/services" }} stats={[{ label: "Resource results", value: resources.data.length }, { label: "Published resources", value: allResources.data.length }, { label: "Centers", value: centers.data.length }, { label: "Categories", value: categories.length }]} />
