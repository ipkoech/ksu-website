    ...
    <Sheet>
      ...
      <SheetContent side="right" className="w-full overflow-y-auto bg-white p-0 sm:max-w-2xl">
        ...
        <div className="grid gap-5 px-6 py-5">
          ...
          {interests.length ? (
            <section>
              <h3 className="text-sm font-semibold text-slate-950">Expertise areas</h3>
          ...
          <section className="rounded-lg border border-slate-200 bg-white p-4">
            <h3 className="text-sm font-semibold text-slate-950">Research profile links</h3>
            <div className="mt-3 flex flex-wrap gap-2">
...
function MetaRow({
  ...
  const content = href ? (
    ...
    <span className="break-words text-slate-900 [overflow-wrap:anywhere]">{value}</span>
  );
