...
export default async function ScholarshipDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <main id="research-main" className="min-h-screen bg-white">
      <ResearchPageIntro eyebrow="Scholarship Call" title={scholarship.name ?? "Research scholarship"} body={compactText(scholarship.summary) || compactText(scholarship.description)} breadcrumbs={[{ label: "Home", href: "/" }, { label: "Scholarships", href: "/scholarships" }, { label: scholarship.name ?? "Scholarship" }]} />
