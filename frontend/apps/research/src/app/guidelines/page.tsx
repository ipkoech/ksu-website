...
export default async function GuidelinesPage({ searchParams }: { searchParams?: Promise<GuidelineParams> }) {
  ...
  return (
    <main id="research-main" className="min-h-screen bg-white">
      <ResearchClusterHero eyebrow="Funding / Support" title="Research guidelines, policies, procedures, and grant guidance." body="Guidelines are presented as controlled documents with version, approval, effective date, review date, mandatory status, and download links." breadcrumbs={[{ label: "Home", href: "/" }, { label: "Funding", href: "/funding" }, { label: "Guidelines" }]} imageSrc="/images/research/research-events-hero.webp" imageAlt="Research support documents, policy guidance, and application procedures" links={supportLinks} primaryAction={{ label: "Open forms", href: "/forms" }} stats={[{ label: "Guideline results", value: guidelines.data.length }, { label: "Published guidelines", value: allGuidelines.data.length }, { label: "Grant guidance", value: grantGuidelines.data.length }, { label: "Categories", value: categories.length }]} />
