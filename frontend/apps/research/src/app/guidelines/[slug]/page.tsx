    ...
    <main id="research-main" className="min-h-screen bg-white">
      ...
      <ResearchSection eyebrow="Document Detail" title="Policy scope, applicability, and controlled version" body="Guidelines show public-facing document control and practical application details." tone="white">
        <div className="grid grid-cols-[minmax(0,1fr)] gap-5 lg:grid-cols-[minmax(0,1fr)_360px]">
          <div className="min-w-0 space-y-5"><ResearchTextPanel title="Summary" fields={[["Summary", guideline.summary], ["Content", guideline.content]]} /><ResearchTextPanel title="Scope and applicability" fields={[["Scope", guideline.scope], ["Applicability", guideline.applicability]]} /></div>
