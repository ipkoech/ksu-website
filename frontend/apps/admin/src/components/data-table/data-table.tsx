...
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from "@ksu/ui/table"; // Assuming this path
...
export function DataTable<T>({ data, columns, toolbar, isLoading, emptyMessage }: DataTableProps<T>) {
