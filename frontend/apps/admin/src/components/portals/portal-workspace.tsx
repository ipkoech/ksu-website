...
export function PortalWorkspace({
  ...
  return (
    <div className={cn("min-h-full bg-muted/20 p-4 sm:p-6 lg:p-8", className)}>
...
export function PortalMetricGrid({ items }: { items: PortalMetric[] }) {
  return (
    <section
...
/** Standard status badge for portal workflows */
