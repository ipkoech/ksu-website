...
import { Badge, Button, Card, CardContent, CardHeader, CardTitle, DeleteConfirmDialog, Input, Label, PageHeader, Textarea } from "@ksu/ui/components";
...
import { canDeleteRoles, canManageRoles, canViewPermissions } from "../../_lib/access";
    ...
    <div>
      <PageHeader
        ...
        primaryAction={canManageRole ? {
          label: "Save changes",
          onClick: async () => {
            await updateRole.mutateAsync({ id, data: form });
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Textarea disabled={!canManageRole} value={form.description} onChange={(event) => setForm((current) => ({ ...current, description: event.target.value }))} />
              </div>
            </CardContent>
          </Card>
        ...
        <div className="space-y-6">
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              {roleUsers.length === 0 ? <p className="text-sm text-muted-foreground">No users currently assigned.</p> : null}
            </CardContent>
          </Card>
