  ...
  return (
    <ResearchContentResourcePage
      ...
      fields={[
        ...
        {
          name: "meeting_link",
          label: "Registration or Meeting URL",
          type: "url",
        },
        {
          name: "scope_id",
          label: "Research Binding",
          type: "entity-record",
          entityRecord: {
            typeName: "scope_type",
            idName: "scope_id",
            description:
              "Attach the event to a real research record when the content service supports the selected scope.",
            ...
            configs: [
              ...
              {
                value: "research_sustainability",
                label: "Sustainability Initiative",
                adapter: "researchSustainability",
                filters: { is_active: true },
              },
            ],
            allowNone: false,
        ...
        },
        {
          ...
          label: "Event Media",
          type: "attachments",
          attachments: { entityType: "event", roles: contentAttachmentRoles },
        },
        {
          name: "author_user_id",
          label: "Owner",
