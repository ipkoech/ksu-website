...
export default function GrantReportsPage() {
  return (
    <ResearchResourcePage
      ...
      {...FundingPageChrome({ guideTitle: "Grant Reports", resourceKey: "research-grant-reports" })}
      ...
      fields={[
        ...
        { name: "activities", label: "Activities", type: "richtext" },
        { name: "achievements", label: "Achievements", type: "richtext" },
        { name: "challenges", label: "Challenges", type: "richtext" },
        { name: "lessons_learned", label: "Lessons Learned", type: "richtext" },
        { name: "next_steps", label: "Next Steps", type: "richtext" },
        ...
        { name: "balance", label: "Balance", type: "number" },
        {
          ...
          type: "entity-multi",
          relation: { adapter: "media", description: "Attach report files, receipts, evidence, and approval documents." },
        ...
        },
        {
          ...
          type: "entity-multi",
          relation: { adapter: "media", description: "Select existing media documents linked to this report." },
