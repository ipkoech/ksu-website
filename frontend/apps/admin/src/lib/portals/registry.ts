...
const schoolResources: Record<string, PortalResourceConfig<any, any>> = {
  profiles: {
    ...
    listFilters: yesNoFilters,
    list: (filters) => schoolsApi.list({ ...pageParams, ...filters }),
  ...
  departments: {
    ...
    list: (filters) => departmentsApi.list({ ...pageParams, ...filters }),
    ...
    dashboard: dashboard(
      ...
      [
        ...
        stat(
          ...
          ["academic.view"],
          ["schools", "departments"],
          () => departmentsApi.list(countParams),
        ),
        stat(
          "Validation Queue",
