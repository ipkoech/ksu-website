...
const USER_DETAIL_FIELDS = "id,email,phone,full_name,avatar_url,push_tokens,is_active,is_verified,last_login_at,failed_login_attempts,locked_until,email_verified_at,roles,person_id,created_at,updated_at";
