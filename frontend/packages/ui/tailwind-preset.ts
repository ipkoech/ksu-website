 ...
 *
 * Single source of truth for the design system's Tailwind layer: color
 * tokens (mapped to the CSS variables in src/globals.css), typography,
 * radii, shadows, motion, and breakpoints. Apps consume it via:
 *
 *   import preset from "@ksu/ui/tailwind-preset";
 *   export default {
 *     presets: [preset],
 *     content: ["./src/**\/*.{ts,tsx}", "../../packages/ui/src/**\/*.{ts,tsx}"],
 *   } satisfies Config;
 *
 * App configs should only add genuinely app-specific extras (e.g. a
 * distinct brand palette) — never re-declare tokens that live here.
 */
  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "brand-overlay": "hsl(var(--brand-overlay))",
        popover: {
      ...
      fontSize: {
        ...
        "7xl": ["var(--font-size-7xl)", { lineHeight: "1.05" }],
      },
      letterSpacing: {
        /* Canonical eyebrow/kicker tracking for uppercase labels. */
        eyebrow: "0.24em",
      },
      spacing: {
        "4.5": "1.125rem",
