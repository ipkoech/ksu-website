...
@pytest.mark.parametrize(
    ...
    [
        ...
        "https://%31%32%37.0.0.1/cover.webp",
        "https://%6cocalhost/cover.webp",
        "https://127%2e0%2e0%2e1/cover.webp",
        "https://%31%32%37.0%2e0.1/cover.webp",
        "https://cdn.example.\ttest/cover.webp",
        "https://127.0.0.1\\@cdn.example.test/cover.webp",
        "https://cdn.ex\u0430mple.test/cover.webp",
...
@pytest.mark.parametrize(
    ...
    [
        ...
        "https://cdn.example.test/covers%2Fcover.webp?format=webp%26fit=cover",
