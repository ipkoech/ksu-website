...
from ...schemas import UserCreate, UserSnapshot, UserUpdate
...
@router.get("", response_model_exclude_unset=True, response_model=SuccessResponse[list[UserSnapshot]], dependencies=[Depends(require_scope("users.view"))])
...
@router.get("/{user_id}", response_model_exclude_unset=True, response_model=SuccessResponse[UserSnapshot], dependencies=[Depends(require_scope("users.view"))])
...
@router.post("", response_model_exclude_unset=True, response_model=SuccessResponse[UserSnapshot], status_code=status.HTTP_201_CREATED, dependencies=[Depends(require_scope("users.create"))])
...
@router.patch("/{user_id}", response_model_exclude_unset=True, response_model=SuccessResponse[UserSnapshot], dependencies=[Depends(require_scope("users.edit"))])
