...
@router.get("/templates", dependencies=[Depends(require_scope("notifications:read"))])
...
@router.post("/templates", status_code=status.HTTP_201_CREATED, dependencies=[Depends(require_scope("notifications:write"))])
...
@router.get("/deliveries", dependencies=[Depends(require_scope("notifications:read"))])
