...
ADMIN_DEPARTMENTS: list[dict[str, Any]] = [
    ...
    {"name": "Registrar Academic Affairs", "code": "ACAFFAIRS", "wing_code": "RAA", "head_key": "registrar_academic", "about": "Registrar Academic Affairs is listed as an official administration department and coordinates admissions, examinations, and academic processes.", "source_url": "https://kisiiuniversity.ac.ke/dpt/registrar-academic-affairs"},
    {"name": "Dean of Students", "code": "STUAFFAIRS", "wing_code": "STUAFFAIRS", "head_key": "dean_students", "about": "Dean of Students is listed as an official administration department supporting student welfare and student life.", "source_url": "https://kisiiuniversity.ac.ke/dpt/dean-of-students"},
    ...
    {"name": "Registrar Administration", "code": "AHRCS", "wing_code": "AHRCS", "head_key": "registrar_admin", "about": "Registrar Administration is listed as an official administration department and is publicly associated with administration, human resource, and central services.", "source_url": "https://kisiiuniversity.ac.ke/dpt/registrar-administration"},
    {"name": "Finance", "code": "FIN", "wing_code": "FIN", "head_key": "finance_officer", "about": "Finance is listed as an official administration department and is publicly headed by the Finance Officer.", "source_url": "https://kisiiuniversity.ac.ke/dpt/finance"},
    ...
    {"name": "Information Communication and Technology (ICT)", "code": "ICT", "wing_code": "ICT", "head_key": "ict_manager", "about": "Information Communication and Technology (ICT) is listed as an official administration department sustaining academic and administrative operations through digital infrastructure, systems, and user support.", "source_url": "https://kisiiuniversity.ac.ke/dpt/information-communication-and-technology-ict"},
    {"name": "Medical Services", "code": "MEDSERV", "wing_code": "MEDICAL", "head_key": "dvc_apf", "about": "Medical Services is listed as an official administration department on the university website.", "source_url": "https://kisiiuniversity.ac.ke/dpt/medical-services"},
    {"name": "Internal Audit", "code": "AUDIT", "wing_code": "AUDIT", "head_key": "dvc_apf", "about": "Internal Audit is listed as an official administration department on the university website.", "source_url": "https://kisiiuniversity.ac.ke/dpt/internal-audit"},
    {"name": "Corporate Communication", "code": "CORPCOMM", "wing_code": "CORPCOMM", "head_key": "dvc_apf", "about": "Corporate Communication is listed as an official administration department on the university website.", "source_url": "https://kisiiuniversity.ac.ke/dpt/corporate-communication"},
    {"name": "Procurement and Supplies", "code": "PROC", "wing_code": "PROC", "head_key": "dvc_apf", "about": "Procurement and Supplies is listed as an official administration department on the university website.", "source_url": "https://kisiiuniversity.ac.ke/dpt/procurement-and-supplies"},
    {"name": "Legal Department", "code": "LEGAL", "wing_code": "LEGAL", "head_key": "dvc_apf", "about": "Legal Department is listed as an official administration department on the university website.", "source_url": "https://kisiiuniversity.ac.ke/dpt/legal-department"},
