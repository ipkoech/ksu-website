...
RESOURCE_CONFIGS: dict[str, ImportResourceConfig] = {
    ...
    "research-sliders": ImportResourceConfig(
        key="research-sliders",
        label="Research Sliders",
        description="Bulk create research hero slider records via the research service.",
        scope="research:write",
        schema=ResearchImportSchema,
        create=_make_research_create("/api/v1/sliders"),
        columns=(
            _column("title", required=True, sample="Research Excellence at Kisii University"),
            _column("slug", sample="research-excellence-at-kisii-university"),
            _column("subtitle", sample="Discover innovation, partnerships, and impact."),
            _column("slider_type", sample="hero"),
            _column("placement", sample="research_homepage"),
            _column("link_text", sample="Explore Research"),
            _column("external_url", sample="/projects"),
            _column("is_public", sample=True),
        ),
    ),
    "research-news": ImportResourceConfig(
        key="research-news",
        label="Research News",
        description="Bulk create research news records via the research service.",
        scope="research:write",
        schema=ResearchImportSchema,
        create=_make_research_create("/api/v1/news"),
        columns=(
            _column("title", required=True, sample="Kisii University Researchers Win NRF Grant"),
            _column("slug", sample="kisii-university-researchers-win-nrf-grant"),
            _column("news_type", sample="award"),
            _column("summary", sample="A team of researchers has been awarded a KSh 15M grant."),
            _column("plain_text", sample="The National Research Fund has awarded a KSh 15 million grant..."),
            _column("is_public", sample=True),
        ),
    ),
    "research-articles": ImportResourceConfig(
        key="research-articles",
        label="Research Articles",
        description="Bulk create research article/blog records via the research service.",
        scope="research:write",
        schema=ResearchImportSchema,
        create=_make_research_create("/api/v1/articles"),
        columns=(
            _column("title", required=True, sample="The Role of AI in Agricultural Research"),
            _column("slug", sample="the-role-of-ai-in-agricultural-research"),
            _column("article_type", sample="blog"),
            _column("summary", sample="Exploring how artificial intelligence is transforming agricultural research."),
            _column("plain_text", sample="Artificial intelligence is rapidly changing the landscape of agricultural research..."),
            _column("is_public", sample=True),
        ),
    ),
}
