...
router.include_router(build_crud_router(prefix="/mentorship-applications", tag="Mentorship Applications", service=MentorshipApplicationService, create_schema=MentorshipApplicationCreate, update_schema=MentorshipApplicationUpdate, write_scope="training_program.manage"))
router.include_router(build_crud_router(prefix="/mentorship-matches", tag="Mentorship Matches", service=MentorshipMatchService, create_schema=MentorshipMatchCreate, update_schema=MentorshipMatchUpdate, write_scope="training_program.manage"))
