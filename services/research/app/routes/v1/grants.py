...
router.include_router(build_crud_router(prefix="/grant-applications", tag="Grant Applications", service=ApplicationService, create_schema=GrantApplicationCreate, update_schema=GrantApplicationUpdate, write_scope="funding.manage"))
...
router.include_router(build_crud_router(prefix="/grant-reviews", tag="Grant Reviews", service=ReviewService, create_schema=GrantReviewCreate, update_schema=GrantReviewUpdate, write_scope="funding.manage"))
router.include_router(build_crud_router(prefix="/grant-reports", tag="Grant Reports", service=ReportService, create_schema=GrantReportCreate, update_schema=GrantReportUpdate, write_scope="funding.manage"))
