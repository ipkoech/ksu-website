...
@router.get("/farms/id/{farm_id}/projects", tags=["Research Farms"], response_model=SuccessEnvelope[list[JsonObject]])
@cached_public(timeout=300)
...
@router.put("/farms/id/{farm_id}/projects/{project_id}", tags=["Research Farms"], dependencies=[Depends(require_scope("research.manage_projects"))], response_model=SuccessEnvelope[JsonObject])
...
@router.delete("/farms/id/{farm_id}/projects/{project_id}", tags=["Research Farms"], dependencies=[Depends(require_scope("research.manage_projects"))], response_model=SuccessEnvelope[JsonObject])
async def remove_farm_project(farm_id: uuid.UUID, project_id: uuid.UUID, db: AsyncSession = Depends(get_db)):
    ...
    return success(data={"farm_id": farm_id, "project_id": project_id, "deleted": True}, message="Farm project unlinked")


@router.get("/farms/id/{farm_id}/partners", tags=["Research Farms"], response_model=SuccessEnvelope[list[JsonObject]])
@cached_public(timeout=300)
...
@router.get("/farms/id/{farm_id}/activities", tags=["Research Farms"], response_model=SuccessEnvelope[list[JsonObject]])
@cached_public(timeout=300)
...
@router.get("/farms/id/{farm_id}/impact-stories", tags=["Research Farms"], response_model=SuccessEnvelope[list[JsonObject]])
@cached_public(timeout=300)
...
@router.get("/centers/id/{center_id}/projects", tags=["Research Centers"], response_model=SuccessEnvelope[list[JsonObject]])
@cached_public(timeout=300)
...
@router.get("/centers/id/{center_id}/programs", tags=["Research Centers"], response_model=SuccessEnvelope[list[JsonObject]])
@cached_public(timeout=300)
...
@router.get("/centers/id/{center_id}/farms", tags=["Research Centers"], response_model=SuccessEnvelope[list[JsonObject]])
@cached_public(timeout=300)
...
@router.get("/centers/id/{center_id}/focus-areas", tags=["Research Centers"], response_model=SuccessEnvelope[list[JsonObject]])
@cached_public(timeout=300)
...
@router.get("/centers/id/{center_id}/partners", tags=["Research Centers"], response_model=SuccessEnvelope[list[JsonObject]])
@cached_public(timeout=300)
...
@router.get("/public/heri/centers/{center_id}/partners", tags=["HERI Public"], response_model=SuccessEnvelope[list[JsonObject]])
@cached_public(timeout=300)
...
@router.put("/centers/id/{center_id}/partners/{partner_id}", tags=["Research Centers"], dependencies=[Depends(require_scope("research.manage_projects"))], response_model=SuccessEnvelope[JsonObject])
...
@router.delete("/centers/id/{center_id}/partners/{partner_id}", tags=["Research Centers"], dependencies=[Depends(require_scope("research.manage_projects"))], response_model=SuccessEnvelope[JsonObject])
async def remove_center_partner(center_id: uuid.UUID, partner_id: uuid.UUID, db: AsyncSession = Depends(get_db)):
    ...
    return success(data={"center_id": center_id, "partner_id": partner_id, "deleted": True}, message="Center partner unlinked")


@router.put("/centers/id/{center_id}/focus-areas/{focus_area_id}", tags=["Research Centers"], dependencies=[Depends(require_scope("research.manage_projects"))], response_model=SuccessEnvelope[JsonObject])
...
@router.delete("/centers/id/{center_id}/focus-areas/{focus_area_id}", tags=["Research Centers"], dependencies=[Depends(require_scope("research.manage_projects"))], response_model=SuccessEnvelope[JsonObject])
async def remove_center_focus_area(center_id: uuid.UUID, focus_area_id: uuid.UUID, db: AsyncSession = Depends(get_db)):
    ...
    return success(data={"center_id": center_id, "focus_area_id": focus_area_id, "deleted": True}, message="Center focus area unlinked")


@router.get("/programs/id/{program_id}/projects", tags=["Research Programs"], response_model=SuccessEnvelope[list[JsonObject]])
@cached_public(timeout=300)
...
@router.get("/programs/id/{program_id}/themes", tags=["Research Programs"], response_model=SuccessEnvelope[list[JsonObject]])
@cached_public(timeout=300)
...
@router.put("/programs/id/{program_id}/themes/{theme_id}", tags=["Research Programs"], dependencies=[Depends(require_scope("research_program.manage"))], response_model=SuccessEnvelope[JsonObject])
...
@router.delete("/programs/id/{program_id}/themes/{theme_id}", tags=["Research Programs"], dependencies=[Depends(require_scope("research_program.manage"))], response_model=SuccessEnvelope[JsonObject])
async def remove_program_theme(program_id: uuid.UUID, theme_id: uuid.UUID, db: AsyncSession = Depends(get_db)):
    ...
    return success(data={"program_id": program_id, "theme_id": theme_id, "deleted": True}, message="Program theme unlinked")
