...
@router.get("/sustainability/id/{sustainability_id}/projects", tags=["Sustainability"], response_model=SuccessEnvelope[list[JsonObject]])
...
@router.put("/sustainability/id/{sustainability_id}/projects/{project_id}", tags=["Sustainability"], dependencies=[Depends(require_scope("sustainability.manage"))], response_model=SuccessEnvelope[JsonObject])
...
@router.delete("/sustainability/id/{sustainability_id}/projects/{project_id}", tags=["Sustainability"], dependencies=[Depends(require_scope("sustainability.manage"))], response_model=SuccessEnvelope[JsonObject])
async def remove_sustainability_project(sustainability_id: uuid.UUID, project_id: uuid.UUID, db: AsyncSession = Depends(get_db)):
    ...
    return success(data={"sustainability_id": sustainability_id, "project_id": project_id, "deleted": True}, message="Sustainability project unlinked")


@router.get("/sustainability/id/{sustainability_id}/partners", tags=["Sustainability"], response_model=SuccessEnvelope[list[JsonObject]])
@cached_public(timeout=300)
...
@router.put("/sustainability/id/{sustainability_id}/partners/{partner_id}", tags=["Sustainability"], dependencies=[Depends(require_scope("sustainability.manage"))], response_model=SuccessEnvelope[JsonObject])
...
@router.delete("/sustainability/id/{sustainability_id}/partners/{partner_id}", tags=["Sustainability"], dependencies=[Depends(require_scope("sustainability.manage"))], response_model=SuccessEnvelope[JsonObject])
async def remove_sustainability_partner(sustainability_id: uuid.UUID, partner_id: uuid.UUID, db: AsyncSession = Depends(get_db)):
    ...
    return success(data={"sustainability_id": sustainability_id, "partner_id": partner_id, "deleted": True}, message="Sustainability partner unlinked")


@router.get("/sustainability/id/{sustainability_id}/training", tags=["Sustainability"], response_model=SuccessEnvelope[list[JsonObject]])
@cached_public(timeout=300)
...
@router.put("/sustainability/id/{sustainability_id}/training/{training_id}", tags=["Sustainability"], dependencies=[Depends(require_scope("sustainability.manage"))], response_model=SuccessEnvelope[JsonObject])
...
@router.delete("/sustainability/id/{sustainability_id}/training/{training_id}", tags=["Sustainability"], dependencies=[Depends(require_scope("sustainability.manage"))], response_model=SuccessEnvelope[JsonObject])
async def remove_sustainability_training(sustainability_id: uuid.UUID, training_id: uuid.UUID, db: AsyncSession = Depends(get_db)):
    ...
    return success(data={"sustainability_id": sustainability_id, "training_id": training_id, "deleted": True}, message="Sustainability training unlinked")


@router.get("/sustainability/id/{sustainability_id}/stories", tags=["Sustainability"], response_model=SuccessEnvelope[list[JsonObject]])
@cached_public(timeout=300)
...
@router.put("/sustainability/id/{sustainability_id}/stories/{story_id}", tags=["Sustainability"], dependencies=[Depends(require_scope("sustainability.manage"))], response_model=SuccessEnvelope[JsonObject])
...
@router.delete("/sustainability/id/{sustainability_id}/stories/{story_id}", tags=["Sustainability"], dependencies=[Depends(require_scope("sustainability.manage"))], response_model=SuccessEnvelope[JsonObject])
async def remove_sustainability_story(sustainability_id: uuid.UUID, story_id: uuid.UUID, db: AsyncSession = Depends(get_db)):
    ...
    return success(data={"sustainability_id": sustainability_id, "story_id": story_id, "deleted": True}, message="Sustainability story unlinked")
