...
router.include_router(build_crud_router(prefix="/scholarship-applications", tag="Scholarship Applications", service=ScholarshipApplicationService, create_schema=ScholarshipApplicationCreate, update_schema=ScholarshipApplicationUpdate, write_scope="scholarship_application.manage", public_read=False))
