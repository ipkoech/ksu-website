...
@router.get("/partners/id/{partner_id}/projects", tags=["Partners"], response_model=SuccessEnvelope[list[JsonObject]])
...
@router.get("/partners/id/{partner_id}/farms", tags=["Partners"], response_model=SuccessEnvelope[list[JsonObject]])
@cached_public(timeout=300)
...
@router.get("/partners/id/{partner_id}/activities", tags=["Partners"], response_model=SuccessEnvelope[list[JsonObject]])
@cached_public(timeout=300)
...
@router.get("/partners/id/{partner_id}/impact-stories", tags=["Partners"], response_model=SuccessEnvelope[list[JsonObject]])
@cached_public(timeout=300)
...
@router.get("/partners/id/{partner_id}/impact-metrics", tags=["Partners"], response_model=SuccessEnvelope[list[JsonObject]])
@cached_public(timeout=300)
...
@router.get("/partners/id/{partner_id}/consultancies", tags=["Partners"], response_model=SuccessEnvelope[list[JsonObject]])
@cached_public(timeout=300)
...
@router.get("/partners/id/{partner_id}/startups", tags=["Partners"], response_model=SuccessEnvelope[list[JsonObject]])
@cached_public(timeout=300)
...
@router.get("/partners/id/{partner_id}/incubation-records", tags=["Partners"], response_model=SuccessEnvelope[list[JsonObject]])
@cached_public(timeout=300)
...
@router.get("/partners/id/{partner_id}/competition-entries", tags=["Partners"], response_model=SuccessEnvelope[list[JsonObject]])
@cached_public(timeout=300)
...
@router.get("/partners/id/{partner_id}/technology-transfer-cases", tags=["Partners"], response_model=SuccessEnvelope[list[JsonObject]])
@cached_public(timeout=300)
...
@router.get("/partners/id/{partner_id}/sustainability", tags=["Partners"], response_model=SuccessEnvelope[list[JsonObject]])
@cached_public(timeout=300)
